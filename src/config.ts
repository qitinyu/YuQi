...
export const siteConfig: SiteConfig = {
	...
	siteURL: "https://yqamm.eu.cc/", // 请替换为你的站点URL，以斜杠结尾
...
export const commentConfig: CommentConfig = {
	...
	twikoo: {
		envId: "https://yuqi-pinlun.netlify.app/.netlify/functions/twikoo",
...
export const announcementConfig: AnnouncementConfig = {
	...
	link: {
		enable: false, // 启用链接
		text: "了解更多？", // 链接文本
		url: "https://yqamm.pages.dev/posts/20260214域名/20260214域名/", // 链接 URL
		external: true, // 内部链接
	},
};
//播放器
...
export const pioConfig: import("./types/config").PioConfig = {
	...
	dialog: {
		welcome: "Welcome to YQ Website!", // 欢迎词
		touch: [
			"你在做什么喵?",
			"请不要摸我喵",
...
export const umamiConfig = {
	...
	apiKey: import.meta.env.UMAMI_API_KEY || "api_orN72pfNvYSAIg317e9LePqYtuM1oV5e", // API密钥优先从环境变量读取，否则使用配置文件中的值

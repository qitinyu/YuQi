...
![图片](https://i.postimg.cc/RVhCndCS/mei-hua1.webp)
<details>
<summary>点击查看</summary>
...
<style>
  ...
  a:hover {
    transform: scale(1.1) translateY(-1.2px); /* 上浮效果 */
    color: #fecfe8;
  }
...
<div style="text-align: center; margin: 0 auto; max-width: 800px; padding: 20px;">
  ...
  <p class="footer-text" style="color:#000">
    生命绚烂，别被黑暗压垮 
    <span style="color: pink;margin-left: 20px;"><i>友情联系：<a href="mailto:484894496@qq.com" style="color:pink">484894496@qq.com</a></i></span>
  </p>
